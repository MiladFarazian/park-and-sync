...
function ChatPane({
  ...
  return (
    <div className="flex flex-col h-full bg-card" style={{ minHeight: 0, transform: 'translateZ(0)', backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden' } as React.CSSProperties}>
      ...
      <div className="flex-1 overflow-y-auto min-h-0" style={{ transform: 'translateZ(0)', backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden' } as React.CSSProperties}>
