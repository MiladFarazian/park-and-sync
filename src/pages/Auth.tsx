              ...
              <TabsContent value="signin">
                <form onSubmit={handleSignIn} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="email" type="email" value={signInData.email} onChange={e => setSignInData({
                    ...signInData,
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="password" type="password" value={signInData.password} onChange={e => setSignInData({
                    ...signInData,
              ...
              <TabsContent value="signup">
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="signupEmail" type="email" value={signUpData.email} onChange={e => setSignUpData({
                    ...signUpData,
                    email: e.target.value
                  })} required />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="signupPassword" type="password" value={signUpData.password} onChange={e => setSignUpData({
                    ...signUpData,
                    password: e.target.value
                  })} required />
                  </div>
