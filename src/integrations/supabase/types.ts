  ...
  public: {
    Tables: {
      availability_rules: {
        ...
        Relationships: [
          {
            foreignKeyName: "availability_rules_spot_id_fkey"
            columns: ["spot_id"]
            isOneToOne: false
      ...
      booking_holds: {
        ...
        Relationships: [
          {
            foreignKeyName: "booking_holds_spot_id_fkey"
            columns: ["spot_id"]
            isOneToOne: false
            referencedRelation: "spots"
            referencedColumns: ["id"]
      ...
      calendar_overrides: {
        ...
        Relationships: [
          {
            foreignKeyName: "calendar_overrides_spot_id_fkey"
            columns: ["spot_id"]
            isOneToOne: false
            referencedRelation: "spots"
            referencedColumns: ["id"]
      ...
      vehicles: {
        Row: {
          ...
          make: string | null
          model: string | null
          size_class: Database["public"]["Enums"]["vehicle_size"]
          updated_at: string
          user_id: string
          year: number | null
        }
    ...
    Enums: {
      booking_status:
        ...
        | "canceled"
        | "refunded"
      spot_status: "active" | "inactive" | "pending_approval"
      user_role: "renter" | "host" | "both"
      vehicle_size: "compact" | "midsize" | "suv" | "truck"
